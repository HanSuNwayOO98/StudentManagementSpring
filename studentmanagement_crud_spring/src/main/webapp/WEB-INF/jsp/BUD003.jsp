...
<body>
<form:form action="courseAddPage" method="get" modelAttribute="coursebean">
    <div id="testheader">
        <div class="container">
            <div class=row>        
                <div class="col-md-5 ">
        ...
        <div class="col-md-6">
        <c:forEach items="${SessionScope.loginlist}" var="data">
            <p>User: </p>
            </c:forEach>
    ...
    <div id="sub_content">
        ...
        <div class="row mb-4">
            ...
            <form:label for="id" class="col-md-2 col-form-label" path="courseId"> ID</form:label>
            <div class="col-md-4">
                <form:input type="text" class="form-control" id="id" path="courseId"/>
            </div>
        </div>

        <div class="row mb-4">
            <div class="col-md-2"></div>
            <form:label for="name" class="col-md-2 col-form-label" path="courseName">Name</form:label>
            <div class="col-md-4">
                <form:input type="text" class="form-control" id="name" path="courseName"/>
            </div>
        </div>
